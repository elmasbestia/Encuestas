...
function moveCorresponding(de,a,Stru) {
    ...
    if(elementos) {
        ...
        for (let i = 0; i < n ;i++) {
            ...
            if (nbCampo) {
                if(campo.type === "radio")
                    if(valores[campo] !== undefined) if(campo.value === valores[campo]) campo.checked = true;
                    else if(Stru[campo] !== undefined) {campo.value = valPorOmision(Stru[campo])}
                else {
                    if(valores[campo] !== undefined) campo.value = valores[campo];
                    else if(Stru[campo] !== undefined) if(campo.value === valPorOmision(Stru[campo]))  campo.checked = true;
                }
            }
        }
    } else {
